...
@MainActor final class TypesTests: XCTestCase {
  ...
  func testFunctionTypeToString() {
    ...
    XCTAssertEqual(
      "(Int) -> Boolean",
      Type.function(.function(argumentTypes: [Type.int], returnType: Type.boolean)).description
    )
    XCTAssertEqual(
      "(String, Boolean) -> Int",
      Type.function(.function(argumentTypes: [Type.string, Type.boolean], returnType: Type.int)).description
    )
  }
